...
;	snake.c:18: unsigned long timer_counter = 0;
	clr	a
	mov	_timer_counter,a
	mov	(_timer_counter + 1),a
	mov	(_timer_counter + 2),a
	mov	(_timer_counter + 3),a
;	snake.c:19: int game_timer_counter = 0;
	mov	_game_timer_counter,a
	mov	(_game_timer_counter + 1),a
;	snake.c:20: char point = 0;
	mov	_point,a
;	snake.c:22: char sqr_left = 61;
	mov	_sqr_left,#0x3d
;	snake.c:23: char cur_dir = dir_right;
	mov	_cur_dir,#0x01
;	snake.c:25: char key_pressed = 0;
	mov	_key_pressed,a
;	snake.c:411: char show_food = 1;
	mov	_show_food,#0x01
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
;	snake.c:129: void game_over(void)
;	-----------------------------------------
;	 function game_over
;	-----------------------------------------
_game_over:
...
;	assignBit
	clr	_EA
;	snake.c:135: for (int i = 0; i < time * 1e3 / 200; i++)
	mov	r6,#0x00
	mov	r7,#0x00
00150$:
	clr	c
	...
	subb	a,#0x80
	jnc	00103$
;	snake.c:137: buzzer_pin = 1;
;	assignBit
	setb	_P1_5
;	snake.c:138: for (int j = 0; j < 90; j++)
	mov	r4,#0x00
	mov	r5,#0x00
00144$:
	clr	c
	...
	sjmp	00144$
00101$:
;	snake.c:140: buzzer_pin = 0;
;	assignBit
	clr	_P1_5
;	snake.c:141: for (int j = 0; j < 90; j++)
	mov	r4,#0x00
	mov	r5,#0x00
00147$:
	clr	c
...
;	snake.c:135: for (int i = 0; i < time * 1e3 / 200; i++)
	...
	sjmp	00150$
00103$:
;	snake.c:144: for (char i = 0; i < 8; i++)
	mov	r7,#0x00
00153$:
	cjne	r7,#0x08,00403$
00403$:
	jnc	00104$
;	snake.c:145: data_mat[i] = 0;
	mov	a,r7
	add	a,#_data_mat
	mov	r0,a
	mov	@r0,#0x00
;	snake.c:144: for (char i = 0; i < 8; i++)
	...
	sjmp	00153$
00104$:
;	snake.c:208: const char temp = rand() % 6;
	lcall	_rand
...
;	snake.c:230: if (point > 2)
	mov	a,_point
	add	a,#0xff - 0x02
	jc	00405$
	ljmp	00239$
00405$:
;	snake.c:235: for (i = 0; i < 8; i++)
00219$:
...
;	snake.c:237: for (j = 0; j < 8; j++)
00205$:
	mov	_game_over_j_65537_111,#0x00
00155$:
;	snake.c:239: data_mat[j] = floating_display[temp][(j + i) % 8] & 0b11110000 |
	...
	mov	r4,a
	anl	ar4,#0xf0
;	snake.c:240: floating_display[temp][(j - i + 8) % 8] & 0b00001111;
	mov	a,r2
	clr	c
...
;	snake.c:237: for (j = 0; j < 8; j++)
	...
	ljmp	00155$
00406$:
;	snake.c:243: for (t = 0; t < 30; t++)
	mov	_game_over_t_65537_111,#0x00
00171$:
;	snake.c:57: P2 = 0b11111111;
	mov	_P2,#0xff
;	snake.c:58: P0 = 0xFF;
	mov	_P0,#0xff
;	snake.c:38: for (char row = 0; row < 8; row++)
	mov	r4,#0x00
00164$:
	cjne	r4,#0x08,00407$
00407$:
	jnc	00132$
;	snake.c:40: const char current_data = data_mat[row];
	mov	a,r4
	add	a,#_data_mat
	mov	r1,a
	mov	_game_over_current_data_983041_136,@r1
;	snake.c:41: for (char i = 0; i < 8; i++)
	mov	b,r4
	inc	b
...
00411$:
	jnc	00129$
;	snake.c:43: SER = (0x80 >> row) & (0x80 >> i);
	mov	b,r2
	inc	b
	mov	r3,#0x80
	clr	a
...
;	assignBit
	clr	_P3_5
;	snake.c:50: P0 = ~current_data;
	mov	a,_game_over_current_data_983041_136
	cpl	a
	mov	_P0,a
;	snake.c:51: for (char i = 0; i < 5; i++)
	mov	r6,#0x00
00161$:
	cjne	r6,#0x05,00415$
00415$:
...
;	snake.c:38: for (char row = 0; row < 8; row++)
	inc	r4
;	snake.c:59: display_led_mat();
	sjmp	00164$
00132$:
;	snake.c:61: for (i = 0; i < 100; i++)
	mov	r6,#0x64
00168$:
	djnz	r6,00168$
;	snake.c:63: SER = 0;
...
;	assignBit
	clr	_P3_5
;	snake.c:71: display_number(point);
	mov	r2,_point
	mov	r3,#0x00
	mov	r4,#0x00
	mov	r6,#0x00
...
;	snake.c:72: display_number(point);
	mov	r2,_point
	mov	r3,#0x00
	mov	r4,#0x00
	mov	r6,#0x00
	...
	mov	a,r6
	lcall	_display_number
;	snake.c:73: display_number(point);
	mov	r2,_point
	mov	r3,#0x00
	mov	r4,#0x00
	mov	r6,#0x00
...
;	snake.c:261: if (i + j < 8)
	...
	pop	ar2
	jnc	00118$
;	snake.c:262: data_mat[j] = (floating_display[temp][(j + i)]) >> i;
	mov	a,_game_over_j_65537_111
	add	a,#_data_mat
	mov	r1,a
	mov	a,_game_over_i_65537_111
...
;	snake.c:265: if (i + j >= 16)
	...
	pop	ar2
	jc	00112$
;	snake.c:266: data_mat[j] = (floating_display[temp][(i + j) % 8]) << (16 - i);
	push	ar4
	push	ar5
	mov	a,_game_over_j_65537_111
	add	a,#_data_mat
...
;------------------------------------------------------------
;	snake.c:285: void update_food(void)
;	-----------------------------------------
;	 function update_food
;	-----------------------------------------
_update_food:
;	snake.c:287: char cnt = sqr_left;
	mov	r7,_sqr_left
;	snake.c:288: for (char i = 0; i < 64; i++)
	mov	r6,#0x00
...
00109$:
	...
	jc	00110$
;	snake.c:105: return (data_mat[a >> 3] & (0x80 >> (a & 7))) != 0;
...
00131$:
	cpl	c
;	snake.c:290: if (value(i))
	mov	_update_food_sloc0_1_0,c
	jc	00105$
;	snake.c:292: if (rand() % cnt == 0)
	push	ar7
	push	ar6
	lcall	_rand
	pop	ar6
...
;------------------------------------------------------------
;	snake.c:300: void update_game(void)
;	-----------------------------------------
;	 function update_game
;	-----------------------------------------
_update_game:
;	snake.c:302: if (head != food && (data_mat[(head / 8)] & (0x80 >> (head % 8))))
	mov	a,_food
	cjne	a,_head,00134$
	sjmp	00102$
00134$:
...
00136$:
	...
	orl	a,r7
	jz	00102$
;	snake.c:304: game_over();
	lcall	_game_over
00102$:
;	snake.c:306: turn_on(head);
;	snake.c:114: data_mat[a >> 3] |= 0x80 >> (a & 7);
	mov	a,_head
	mov	r7,a
	swap	a
	rl	a
...
00139$:
	...
	orl	a,r6
	mov	@r1,a
;	snake.c:307: if (head == food)
	mov	a,_food
	cjne	a,_head,00110$
;	snake.c:309: ++point;
	inc	_point
;	snake.c:311: update_food();
	lcall	_update_food
;	snake.c:313: turn_on(food);
;	snake.c:114: data_mat[a >> 3] |= 0x80 >> (a & 7);
	mov	a,_food
	mov	r7,a
	swap	a
...
00143$:
	...
	orl	a,r6
	mov	@r1,a
;	snake.c:314: --sqr_left;
	dec	_sqr_left
;	snake.c:315: return;
	ret
00110$:
;	snake.c:319: turn_off(tail);
;	snake.c:118: data_mat[a >> 3] &= ~(0x80 >> (a & 7));
	mov	a,_tail
	mov	r7,a
	swap	a
	rl	a
...
00145$:
	...
	anl	a,r6
	mov	@r1,a
;	snake.c:320: char dir = get_direction(tail);
	mov	r7,_tail
;	snake.c:78: char temp = 0x80 >> (tail & 7);
	mov	a,#0x07
	anl	a,r7
	mov	r6,a
	mov	b,r6
...
00149$:
	...
	mov	a,r5
	orl	ar7,a
;	snake.c:321: switch (dir)
	mov	a,r7
	add	a,#0xff - 0x03
	jc	00116$
	mov	a,r7
	add	a,r7
;	snake.c:323: case dir_left:
	mov	dptr,#00151$
	jmp	@a+dptr
00151$:
	sjmp	00104$
...
;	snake.c:324: --tail;
	dec	_tail
;	snake.c:325: break;
;	snake.c:326: case dir_right:
	ret
00105$:
;	snake.c:327: ++tail;
	inc	_tail
;	snake.c:328: break;
;	snake.c:329: case dir_up:
	ret
00106$:
;	snake.c:330: tail -= 8;
	mov	a,_tail
...
;------------------------------------------------------------
;	snake.c:339: void go_up(void)
;	-----------------------------------------
;	 function go_up
;	-----------------------------------------
_go_up:
;	snake.c:341: if (head < 8)
	mov	a,#0x100 - 0x08
	add	a,_head
	jc	00102$
;	snake.c:342: game_over();
	lcall	_game_over
00102$:
;	snake.c:343: if (cur_dir == dir_down)
	mov	a,#0x03
	cjne	a,_cur_dir,00104$
;	snake.c:344: return;
	ret
00104$:
;	snake.c:345: update_direction(head, dir_up);
	mov	r7,_head
	mov	ar6,r7
;	snake.c:84: char temp = 0x80 >> (tail & 7);
	mov	a,#0x07
	anl	a,r7
	mov	r5,a
	mov	b,r5
...
;	snake.c:93: bit0[tail >> 3] &= ~temp;
	...
	anl	a,r7
	mov	@r1,a
;	snake.c:346: head = head - 8;
	mov	a,_head
	add	a,#0xf8
	mov	_head,a
;	snake.c:347: cur_dir = dir_up;
	mov	_cur_dir,#0x02
;	snake.c:348: update_game();
;	snake.c:349: }
	ljmp	_update_game
;------------------------------------------------------------
...
;temp                      Allocated to registers r5 
;------------------------------------------------------------
;	snake.c:350: void go_down(void)
;	-----------------------------------------
;	 function go_down
;	-----------------------------------------
_go_down:
;	snake.c:352: if (head >= 56)
	mov	a,#0x100 - 0x38
	add	a,_head
	jnc	00102$
;	snake.c:353: game_over();
	lcall	_game_over
00102$:
;	snake.c:354: if (cur_dir == dir_up)
	mov	a,#0x02
	cjne	a,_cur_dir,00104$
;	snake.c:355: return;
	ret
00104$:
;	snake.c:356: update_direction(head, dir_down);
	mov	r7,_head
	mov	ar6,r7
;	snake.c:84: char temp = 0x80 >> (tail & 7);
	mov	a,#0x07
...
;	snake.c:93: bit0[tail >> 3] &= ~temp;
	...
	anl	a,r7
	mov	@r1,a
;	snake.c:96: bit0[tail >> 3] |= temp;
	mov	ar7,@r1
	mov	a,r5
	orl	a,r7
	mov	@r1,a
;	snake.c:357: head = head + 8;
	mov	r7,_head
	mov	a,#0x08
	add	a,r7
	mov	_head,a
;	snake.c:358: cur_dir = dir_down;
	mov	_cur_dir,#0x03
;	snake.c:359: update_game();
;	snake.c:360: }
	ljmp	_update_game
;------------------------------------------------------------
...
;temp                      Allocated to registers r5 
;------------------------------------------------------------
;	snake.c:361: void go_left(void)
;	-----------------------------------------
;	 function go_left
;	-----------------------------------------
_go_left:
;	snake.c:363: if (head % 8 == 0)
	mov	a,_head
	anl	a,#0x07
	jz	00123$
	sjmp	00102$
00123$:
;	snake.c:364: game_over();
	lcall	_game_over
00102$:
;	snake.c:365: if (cur_dir == dir_right)
	mov	a,#0x01
	cjne	a,_cur_dir,00104$
;	snake.c:366: return;
	ret
00104$:
;	snake.c:367: update_direction(head, dir_left);
	mov	r7,_head
	mov	ar6,r7
;	snake.c:84: char temp = 0x80 >> (tail & 7);
	mov	a,#0x07
...
;	snake.c:368: --head;
	dec	_head
;	snake.c:369: cur_dir = dir_left;
	mov	_cur_dir,#0x00
;	snake.c:370: update_game();
;	snake.c:371: }
	ljmp	_update_game
;------------------------------------------------------------
...
;temp                      Allocated to registers r5 
;------------------------------------------------------------
;	snake.c:372: void go_right(void)
;	-----------------------------------------
;	 function go_right
;	-----------------------------------------
_go_right:
;	snake.c:374: if (head % 8 == 7)
	mov	a,#0x07
	anl	a,_head
	mov	r6,a
	mov	r7,#0x00
	cjne	r6,#0x07,00102$
	cjne	r7,#0x00,00102$
;	snake.c:375: game_over();
	lcall	_game_over
00102$:
;	snake.c:376: if (cur_dir == dir_left)
	mov	a,_cur_dir
	jnz	00104$
;	snake.c:377: return;
	ret
00104$:
;	snake.c:378: update_direction(head, dir_right);
	mov	r7,_head
	mov	ar6,r7
;	snake.c:84: char temp = 0x80 >> (tail & 7);
	mov	a,#0x07
...
;	snake.c:379: ++head;
	inc	_head
;	snake.c:380: cur_dir = dir_right;
	mov	_cur_dir,#0x01
;	snake.c:381: update_game();
;	snake.c:382: }
	ljmp	_update_game
;------------------------------------------------------------
;Allocation info for local variables in function 'reset_timer_1'
;------------------------------------------------------------
;	snake.c:383: void reset_timer_1(void)
;	-----------------------------------------
;	 function reset_timer_1
;	-----------------------------------------
_reset_timer_1:
;	snake.c:386: TH1 = 0x4B; // Thiết lập giá trị đầu tiên của thanh ghi đếm cao
	mov	_TH1,#0x4b
;	snake.c:387: TL1 = 0xFF; // Thiết lập giá trị đầu tiên của thanh ghi đếm thấp
	mov	_TL1,#0xff
;	snake.c:388: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	snake.c:390: void key_pressed_handle(void)
;	-----------------------------------------
;	 function key_pressed_handle
;	-----------------------------------------
_key_pressed_handle:
;	snake.c:392: reset_timer_1();
	lcall	_reset_timer_1
;	snake.c:393: game_timer_counter = -7;
	mov	_game_timer_counter,#0xf9
	mov	(_game_timer_counter + 1),#0xff
;	snake.c:394: switch (key_pressed)
	mov	a,#0x02
...
;a                         Allocated to registers 
;------------------------------------------------------------
;	snake.c:412: void timer1_interrupt(void) __interrupt(3)
;	-----------------------------------------
...
00133$:
;	snake.c:416: reset_timer_1();
	lcall	_reset_timer_1
;	snake.c:417: ++game_timer_counter;
	inc	_game_timer_counter
	clr	a
	cjne	a,_game_timer_counter,00134$
	inc	(_game_timer_counter + 1)
00134$:
;	snake.c:418: if (!(timer_counter % 3))
	...
	orl	a,r7
	jnz	00105$
;	snake.c:420: if (show_food)
	mov	a,_show_food
	jz	00102$
;	snake.c:422: turn_off(food);
;	snake.c:118: data_mat[a >> 3] &= ~(0x80 >> (a & 7));
	mov	a,_food
	mov	r7,a
	swap	a
...
00138$:
	...
	anl	a,r6
	mov	@r1,a
;	snake.c:423: show_food = 0;
	mov	_show_food,#0x00
	sjmp	00105$
00102$:
;	snake.c:427: turn_on(food);
;	snake.c:114: data_mat[a >> 3] |= 0x80 >> (a & 7);
	mov	a,_food
	mov	r7,a
	swap	a
...
00140$:
	...
	orl	a,r6
	mov	@r1,a
;	snake.c:428: show_food = 1;
	mov	_show_food,#0x01
00105$:
;	snake.c:431: if (!(game_timer_counter % 10))
...
00143$:
	...
	ljmp	00106$
	ljmp	00107$
;	snake.c:435: case (dir_up):
00106$:
;	snake.c:436: go_up();
	lcall	_go_up
;	snake.c:437: break;
;	snake.c:438: case (dir_down):
	sjmp	00115$
00107$:
;	snake.c:439: go_down();
	lcall	_go_down
;	snake.c:440: break;
;	snake.c:441: case (dir_left):
	sjmp	00115$
00108$:
;	snake.c:442: go_left();
	lcall	_go_left
;	snake.c:443: break;
;	snake.c:444: case (dir_right):
	sjmp	00115$
00109$:
;	snake.c:445: go_right();
	lcall	_go_right
;	snake.c:447: }
00115$:
;	snake.c:450: }
...
;i                         Allocated to registers r7 
;------------------------------------------------------------
;	snake.c:452: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	snake.c:455: IT0 = 1; // Falling edge trigger
;	assignBit
	setb	_IT0
;	snake.c:456: EX0 = 1; // Enable INT0 interrupt
;	assignBit
	setb	_EX0
;	snake.c:457: EA = 1;  // Enable global interrupt flag
;	assignBit
	setb	_EA
;	snake.c:459: TMOD = 0x12; // Timer 0 mode 1 (16-bit timer
	mov	_TMOD,#0x12
;	snake.c:461: TH1 = 0x4B; // Thiết lập giá trị đầu tiên của thanh ghi đếm cao
	mov	_TH1,#0x4b
;	snake.c:462: TL1 = 0xFF; // Thiết lập giá trị đầu tiên của thanh ghi đếm thấp
	mov	_TL1,#0xff
;	snake.c:465: ET1 = 1;
;	assignBit
	setb	_ET1
;	snake.c:467: reset_timer_1();
	lcall	_reset_timer_1
;	snake.c:468: TR1 = 1;
;	assignBit
	setb	_TR1
;	snake.c:470: while (get_pressed_key() == 0)
00101$:
...
00154$:
	...
	sjmp	00189$
00158$:
;	snake.c:30: char bit1[8]; // 0 : horizontal 1: vertical
	jb	_P1_5,00163$
00159$:
	jnb	_P1_5,00159$
	mov	r7,#0x0b
...
00169$:
	...
	sjmp	00189$
00173$:
;	snake.c:36: inline void display_led_mat(void)
	jb	_P1_6,00178$
00174$:
	jnb	_P1_6,00174$
	mov	r7,#0x08
...
00189$:
	...
	ljmp	00101$
00665$:
;	snake.c:473: srand(timer_counter);
	mov	dpl,_timer_counter
	mov	dph,(_timer_counter + 1)
	lcall	_srand
;	snake.c:475: P0 = 0x00;
...
;	snake.c:484: tail = 0;
	mov	_tail,#0x00
;	snake.c:486: update_food();
	lcall	_update_food
;	snake.c:487: turn_on(food);
;	snake.c:114: data_mat[a >> 3] |= 0x80 >> (a & 7);
	mov	a,_food
	mov	r7,a
	swap	a
...
;	keymatrix.h:39: return 0;
	mov	r7,#0x00
;	snake.c:492: key_pressed = get_pressed_key();
00293$:
;	snake.c:493: if (key_pressed)
	mov	a,r7
	mov	_key_pressed,a
	jnz	00713$
	ljmp	00107$
00713$:
;	snake.c:495: key_pressed_handle();
