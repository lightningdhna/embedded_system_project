...
{
    // TF1 = 0;
    TH0 = 0x4B; // Thiết lập giá trị đầu tiên của thanh ghi đếm cao
    TL0 = 0xFF; // Thiết lập giá trị đầu tiên của thanh ghi đếm thấp
}
...
void main(void)
{
    ...
    TMOD = 0x21; // Timer 0 mode 1 (16-bit timer
